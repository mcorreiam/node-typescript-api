...
import stormGlassNormalizedResponseFixture from '../../../test/fixtures/stormGlass_normalized_response_3_hours.json'; //' /fixtures/stormglass_normalized_response_3_hours.json';
